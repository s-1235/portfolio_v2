  ...
  return (
    <>
      <div id='menu-target' data-scroll-container ref={refScroll}>
        <Head>
          <link rel='icon' href='svg/mazen_logo.svg' />
          <meta name='theme-color' content='#10101A' />
          <meta
            name='apple-mobile-web-app-status-bar-style'
            content='#10101A'
          />
          <title>Mazen Jamshed 🚀 &mdash; Software Engineer</title>
          <meta
            name='description'
          ...
          <meta
            property='og:title'
            content='Mazen Jamshed 🚀 &mdash; Software Engineer'
          />
        ...
        >
          <div className='preloader__wrapper'>
            ...
            >
              <img src='svg/mazen_logo.svg' alt='mazen jamshed logo' />
            </motion.div>
            <motion.div
              initial={{ x: 10, opacity: 0 }}
              animate={{ x: 0, opacity: 1, transition: { ...transition } }}
            ...
            >
              ...
              <p className='preloader__text'>NFT</p>
        ...
        <div className='header-wrapper'>
          ...
          <div className='header__footer'>
            ...
            <div className='header__footer--right'>
              ...
              <a
                href='https://www.linkedin.com/in/mazenjamshed/'
                rel='noopener'
                target='_blank'
              >
                💼 LD
        ...
        <footer className='footer'>
          <img
            src='svg/mazen_logo_footer.svg'
            alt='design and devloped by mazen jamshed
            '
          />
